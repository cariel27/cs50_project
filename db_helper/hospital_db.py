...
class HospitalDb:
    ...
    def populate_db(self, rows_qty=10):
        ...
        for _ in range(rows_qty):
            self._insert_row(first_name=f.name(), last_name=f.name(), ssn=f.ssn(),
    ...
    def _insert_row(self, **kwargs):
        self.db.insert(first_name=kwargs["first_name"], last_name=kwargs["last_name"], ssn=kwargs.get("ssn", None),
                       blood_type=kwargs.get("blood_type", None),
                       height=kwargs.get("height", None),
                       weight=kwargs.get("weight", None),
                       doctor=kwargs.get("doctor", None))
